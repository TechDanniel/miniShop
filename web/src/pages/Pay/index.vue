      ...
      <div class="checkout-tit">
        ...
        <div class="paymark">
          <span class="fl"
            ...
            {{payInfo.orderNo}}</em></span
          >
          <span class="fr"
            ><em class="lead">应付金额：</em
            ><em class="orange money">￥{{ payInfo.totalAmount }}</em></span
          >
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    async pay() {
      ...
      let imgUrl = await qrcode.toDataURL(this.payInfo.orderNo);
      ...
      this.timer = setInterval(async ()=>{
           let result  = await this.$store.dispatch("payStatus",this.payInfo.orderNo);
